package com.likelion.cr_test.member.application;



import com.likelion.cr_test.common.error.ErrorCode;
import com.likelion.cr_test.common.exception.BusinessException;
import com.likelion.cr_test.member.api.dto.request.MemberSaveRequestDto;
...
public class MemberService {
    ...
    public MemberInfoResponseDto memberFindOne(Long memberId) {
        Member member = memberRepository
                .findById(memberId)
                .orElseThrow(() -> new BusinessException(ErrorCode.MEMBER_NOT_FOUND_EXCEPTION, ErrorCode.MEMBER_NOT_FOUND_EXCEPTION.getMessage() + memberId));
